...
public class ConfigurationManagerInstrumentedTest {
    ...
    /**
     * Checks that a call to {@link ConfigurationManager#isInitialised()} should return {@code true} after a call
     * made to {@link ConfigurationManager#init(Context)}.
     */
    @Test
    ...
    /**
     * Checks that a call to {@link ConfigurationManager#isInitialised()} should return {@code false} after a call
     * made to {@link ConfigurationManager#reset()}.
     */
    @Test
