...
public class TraceSdkInstrumentedTest {
  ...
  /**
   * Tests that {@link TraceSdk#isInitialised()} should return {@code true}, when the SDK has
   * been initialised.
   */
  @Test
  ...
  /**
   * Tests that {@link TraceSdk#isInitialised()} should return {@code false}, when the SDK
   * hasn't been initialised ({@link TraceSdk#init(Context)} not called).
   */
  @Test
