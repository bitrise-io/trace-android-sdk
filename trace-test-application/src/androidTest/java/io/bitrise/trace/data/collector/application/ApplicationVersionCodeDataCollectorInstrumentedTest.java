...
public class ApplicationVersionCodeDataCollectorInstrumentedTest {
    ...
    /**
     * Verifies that when {@link ApplicationVersionCodeDataCollector#collectData()} is called, the content of the
     * returned {@link Data} should match with the predefined value.
     */
    @Test
    public void collectData_contentShouldMatch() {
        ...
        final String actualValue = (String) applicationVersionCodeDataCollector.collectData().getContent();
