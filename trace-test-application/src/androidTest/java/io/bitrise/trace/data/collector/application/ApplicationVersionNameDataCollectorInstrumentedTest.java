...
public class ApplicationVersionNameDataCollectorInstrumentedTest {
    ...
    /**
     * Verifies that when {@link ApplicationVersionNameDataCollector#collectData()} is called, the content of the
    ...
    public void collectData_contentShouldMatch() {
        ...
        final String actualValue = (String) applicationVersionNameDataCollector.collectData().getContent();
