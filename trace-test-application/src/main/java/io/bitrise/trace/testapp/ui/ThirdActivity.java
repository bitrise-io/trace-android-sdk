...
/**
 * Similar to {@link MainActivity} and {@link SecondActivity}, but this is a {@link Activity} and
 * not {@link AppCompatActivity} to test the deprecated {@link android.app.Fragment} behaviour.
  ...
  private void setupView() {
    ...
    parentFragmentButton.setOnClickListener(v ->
        getFragmentManager().beginTransaction()
                            .add(R.id.deprecated_activity_frame, new ParentDeprecatedFragment())
                            .commit());
  }
}
