...
public abstract class BaseNetworkActivity extends AppCompatActivity {
  ...
  /**
   * Displays an error on the screen by clearing the response code, and setting the body to the
   * error message.
   *
  ...
  /**
   * Enables the sending by enabling clicking on buttons {@link #btnConnectHttp} and
   * {@link #btnConnectHttps}.
   *
  ...
  /**
   * Gets the title content for {@link #lblTitle}. The title should be the given networking
   * library's name.
   *
   * @return the title.
   */
