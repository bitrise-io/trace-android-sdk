...
public class ResourceDaoInstrumentedTest {
    ...
    /**
     * Asserts that if we add a {@link ResourceEntity} to the {@link TraceDatabase} via the {@link MetricDao} it will be
    ...
    /**
     * Asserts that if we add a {@link ResourceEntity} to the {@link TraceDatabase} via the {@link ResourceDao}, then
     * delete it, it will not be returned when queried.
     */
    @Test
    ...
    /**
     * Asserts that if we add a {@link ResourceEntity} to the {@link TraceDatabase} via the {@link ResourceDao}
     * multiple times, only one instance will be stored.
     */
    @Test
    ...
    /**
     * Asserts that if we add {@link ResourceEntity}s to the {@link TraceDatabase}, then we query them, all of them
     * will be returned.
     */
    @Test
    public void getAll_shouldReturnAll() {
        ...
        final List<ResourceEntity> actualValues = resourceDao.getAll();
        final ResourceEntity[] expectedValues = new ResourceEntity[]{sampleResourceEntity, otherResourceEntity};
    ...
    /**
     * Asserts that if we add {@link ResourceEntity}s to the {@link TraceDatabase}, then we delete all, the database
     * will be empty.
     */
    @Test
    ...
    /**
     * Asserts that if we add {@link ResourceEntity}s to the {@link TraceDatabase}, then we delete by {@link Session}
     * ID, only ResourceEntities with different Session ID will be left in the database.
     */
    @Test
