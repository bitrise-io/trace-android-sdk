...
public class OkHttpDataListenerInstrumentedTest {
  ...
  /**
   * Checks that {@link OkHttpDataListener#processOkHttpCall(Request, Response, long, long)}
   * should call {@link OkHttpDataListener#onDataCollected(Data)}.
   */
  @Test
  public void processOkHttpCall_ShouldCallOnDataCollected() {
    ...
    doCallRealMethod().when(okHttpDataListener)
