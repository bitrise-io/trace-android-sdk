...
public class ApplicationForegroundStateDataListenerInstrumentedTest {
  ...
  /**
   * When the collection for {@link ApplicationForegroundStateDataListener} is started, it
   * should be active.
   */
  @Test
  ...
  /**
   * When the collection for {@link ApplicationForegroundStateDataListener} is stopped, it should
   * not be active.
   */
  @Test
  ...
  public void isAppIsInForeground_ShouldBeFalseWithNoActivity() {
    assertThat(applicationForegroundStateDataListener.hasApplicationJustComeFromBackground(),
        is(false));
  }
   ...
   * {@link ApplicationForegroundStateDataListener#stopCollecting()},
   * starting an Activity should not make it return {@code true} for checking if it is in the
   * foreground.
   */
  @Test
