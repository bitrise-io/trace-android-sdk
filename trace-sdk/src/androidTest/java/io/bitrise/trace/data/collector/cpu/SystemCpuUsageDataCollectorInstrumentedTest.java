...
public class SystemCpuUsageDataCollectorInstrumentedTest extends BaseDataCollectorInstrumentedTest {
   ...
   * {@link SystemCpuUsageDataCollector#collectData()} is called, the content of the returned
   ...
   * Verifies that when we have access to the proc/stat files,
   * {@link SystemCpuUsageDataCollector#collectData()} is called, the content of the returned
   * {@link CpuUsageData.CpuStat} for System usage should not be {@code null}.
   */
  @Test
   ...
   * {@link SystemCpuUsageDataCollector#collectData()} is called, in the returned
   * {@link CpuUsageData.CpuStat} for System usage the user value should be greater than zero.
   */
  @Test
   ...
   * Verifies that when we have access to the proc/stat files, and
   * {@link SystemCpuUsageDataCollector#collectData()} is called, in the returned
   * {@link CpuUsageData.CpuStat} for System usage the system value should be greater than zero.
   */
  @Test
   ...
   * Verifies that when we have access to the proc/stat files, and
   * {@link SystemCpuUsageDataCollector#collectData()} is called, in the returned
   * {@link CpuUsageData.CpuStat} for System usage the nice value should be greater than zero.
   */
  @Test
   ...
   * Verifies that when we have access to the proc/stat files, and
   * {@link SystemCpuUsageDataCollector#collectData()} is called, in the returned
   * {@link CpuUsageData.CpuStat} for System usage the idle value should be greater than zero.
   */
  @Test
   ...
   * Verifies that when we have access to the proc/stat files, and
   * {@link SystemCpuUsageDataCollector#collectData()} is called, in the returned
   * {@link CpuUsageData.CpuStat} for System usage the ioWait value should be greater than zero.
   */
  @Test
   ...
   * Verifies that when we have access to the proc/stat files, and
   * {@link SystemCpuUsageDataCollector#collectData()} is called, in the returned
   * {@link CpuUsageData.CpuStat} for System usage the irq value should be greater than zero.
   */
  @Test
   ...
   * {@link SystemCpuUsageDataCollector#getSystemCpuUsage()} is called, the returned
  ...
  /**
   * Verifies that when when we do have access to the proc/stat files and
   * {@link SystemCpuUsageDataCollector#getCpuUsage()} is called, the returned
   * {@link CpuUsageData.CpuStat} should be not {@code null} and all values should be between 0
   * and 100.
   */
  @Test
  ...
  /**
   * Verifies that when when we do have access to the proc/stat files and
   * {@link SystemCpuUsageDataCollector#getCoresUsage(java.io.RandomAccessFile, int)} is called,
   * the returned {@link CpuUsageData.CpuStat} should be not {@code null}.
   *
  ...
  public void getCoresUsage_resultShouldNotBeNull() throws IOException {
    ...
    final ArrayList<CpuUsageData.CpuStat> actualValue = collector.getCoresUsage(randomAccessFile,
   ...
   * Verifies that when when we do not have access to the proc/stat files and
   * {@link SystemCpuUsageDataCollector#getCoresUsage(java.io.RandomAccessFile, int)} is called,
   * the returned {@link CpuUsageData.CpuStat} should be {@code null}.
     *
