...
public class MetricDaoInstrumentedTest {
  ...
  /**
   * Asserts that if we add a {@link MetricEntity} to the {@link TraceDatabase} via the
  ...
  /**
   * Asserts that if we add a {@link MetricEntity} to the {@link TraceDatabase} via the
   * {@link MetricDao}, then delete it, it will not be returned when queried.
   */
  @Test
  ...
  /**
   * Asserts that if we add a {@link MetricEntity} to the {@link TraceDatabase} via the
   * {@link MetricDao} multiple times, only one instance will be stored.
   */
  @Test
  ...
  /**
   * Asserts that if we add {@link MetricEntity}s to the {@link TraceDatabase} with multiple
  ...
  /**
   * Asserts that if we add {@link MetricEntity}s to the {@link TraceDatabase}, then we query
  ...
  public void getAll_shouldReturnAll() {
    ...
    final List<MetricEntity> actualValues = metricDao.getAll();
    final MetricEntity[] expectedValues =
        new MetricEntity[] {sampleMetricEntity, otherMetricEntity};
    assertThat(actualValues, containsInAnyOrder(expectedValues));
  }
  ...
  public void getBySessionId_shouldReturnAllWithSessionId() {
    ...
    final MetricEntity differentMetricEntity =
        new MetricEntity(MetricTestProvider.getEmptyMetric());
  ...
  /**
   * Asserts that if we add {@link MetricEntity}s to the {@link TraceDatabase}, then we query one
  ...
  /**
   * Asserts that if we add {@link MetricEntity}s to the {@link TraceDatabase}, then we query a
  ...
  /**
   * Asserts that if we add {@link MetricEntity}s to the {@link TraceDatabase}, then we delete
