...
public class TraceDaoInstrumentedTest {
    ...
    /**
     * Asserts that if we add a {@link TraceEntity} to the {@link TraceDatabase} via the {@link TraceDao} it will be
    ...
    /**
     * Asserts that if we add a {@link TraceEntity} to the {@link TraceDatabase} via the {@link TraceDao}, then
    ...
    /**
     * Asserts that if we add a {@link TraceEntity} to the {@link TraceDatabase} via the {@link TraceDao} multiple
    ...
    /**
     * Asserts that if we add {@link TraceEntity}s to the {@link TraceDatabase} with multiple {@link Session} IDs,
    ...
    /**
     * Asserts that if we add {@link TraceEntity}s to the {@link TraceDatabase}, then we query them, all of them
     * will be returned.
     */
    @Test
    ...
    /**
     * Asserts that if we add {@link TraceEntity}s to the {@link TraceDatabase}, then we query one of them its ID,
    ...
    /**
     * Asserts that if we add {@link TraceEntity}s to the {@link TraceDatabase}, then we query a non existing ID, it
    ...
    /**
     * Asserts that if we add {@link TraceEntity}s to the {@link TraceDatabase}, then we delete all, the database
     * will be empty.
     */
    @Test
