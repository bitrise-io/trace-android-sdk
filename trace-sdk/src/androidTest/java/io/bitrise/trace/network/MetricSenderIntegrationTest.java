 ...
 *
 * <p>Note: to run these tests locally, you need to add a traceToken property to local.properties
...
public class MetricSenderIntegrationTest {
  ...
  /**
   * Method that sends an individual metric to the back end and confirms the metric count and
   * metric label were accepted.
   *
  ...
  public void sendMetric_applicationMemoryUsage() throws IOException {
    ...
    final ApplicationUsedMemoryDataCollector collector =
