...
public class PidCpuStatTest {
    ...
    public void toString_shouldMatchWithContent() {
        final String expected = "AppCpuStat{utime=1.0, stime=2.0, cutime=3.0, cstime=4.0, starttime=5.0}";
        assertEquals(expected, pidCpuStat.toString());
    }

    @Test
    public void toString_shouldMatchNoContent() {
        final String expected = "AppCpuStat{utime=0.0, stime=0.0, cutime=0.0, cstime=0.0, starttime=0.0}";
