...
public class TraceActivityLifecycleTrackerTest {
  ...
  private static final Application mockApplication = mock(Application.class);
  ...
  public void isSingleton_ShouldBeTrue() {
    final TraceActivityLifecycleTracker expectedValue =
   ...
   * {@link TraceActivityLifecycleTracker#onActivityCreated(Activity, Bundle)} method of it
   * should not be called when the
   * {@link TraceActivityLifecycleTracker#onActivityCreated(Activity, Bundle)} is called.
   */
  @Test
  public void onActivityCreated_ShouldBeNeverCalledIfNotRegistered() {
    ...
    verify(mockApplicationForegroundStateDataListener, never())
        .onActivityCreated(any(Activity.class),
            any(Bundle.class));
  }

  /**
   * If the given {@link TraceActivityLifecycleSink} is registered in the the
   * {@link TraceActivityLifecycleTracker} the
   * {@link TraceActivityLifecycleTracker#onActivityCreated(Activity, Bundle)} method of it
  ...
  public void onActivityCreated_ShouldBeCalledIfRegistered() {
    traceActivityLifecycleTracker
        .registerTraceActivityLifecycleSink(mockApplicationForegroundStateDataListener);
    traceActivityLifecycleTracker.onActivityCreated(mockActivity, new Bundle());
    verify(mockApplicationForegroundStateDataListener, times(1))
        .onActivityCreated(any(Activity.class),
            any(Bundle.class));
  }
  ...
  public void onActivityCreated_ShouldBeNeverCalledIfUnregistered() {
    traceActivityLifecycleTracker
        .registerTraceActivityLifecycleSink(mockApplicationForegroundStateDataListener);
    traceActivityLifecycleTracker
        .unregisterTraceActivityLifecycleSink(mockApplicationForegroundStateDataListener);
    traceActivityLifecycleTracker.onActivityCreated(mockActivity, new Bundle());
    verify(mockApplicationForegroundStateDataListener, never())
        .onActivityCreated(any(Activity.class),
            any(Bundle.class));
   ...
   * If the given {@link TraceActivityLifecycleSink} is not registered in the the
   * {@link TraceActivityLifecycleTracker} the
   * {@link TraceActivityLifecycleTracker#onActivityStarted(Activity)} method of it should not be
   * called when the {@link TraceActivityLifecycleTracker#onActivityStarted(Activity)} is called.
   */
  @Test
  public void onActivityStarted_ShouldBeNeverCalledIfNotRegistered() {
    ...
    verify(mockApplicationForegroundStateDataListener, never())
        .onActivityStarted(any(Activity.class));
  }

  /**
   * If the given {@link TraceActivityLifecycleSink} is registered in the the
   * {@link TraceActivityLifecycleTracker} the
   * {@link TraceActivityLifecycleTracker#onActivityStarted(Activity)} method of it should be
   * called when the {@link TraceActivityLifecycleTracker#onActivityStarted(Activity)} is called.
   */
  @Test
   ...
   * If the given {@link TraceActivityLifecycleSink} is not registered in the the
   * {@link TraceActivityLifecycleTracker} the
   * {@link TraceActivityLifecycleTracker#onActivityResumed(Activity)} method of it should not be
   * called when the {@link TraceActivityLifecycleTracker#onActivityResumed(Activity)} is called.
   */
  @Test
  public void onActivityResumed_ShouldBeNeverCalledIfNotRegistered() {
    ...
    verify(mockApplicationForegroundStateDataListener, never())
        .onActivityResumed(any(Activity.class));
  }

  /**
   * If the given {@link TraceActivityLifecycleSink} is registered in the the
   * {@link TraceActivityLifecycleTracker}
   * the {@link TraceActivityLifecycleTracker#onActivityResumed(Activity)} method of it should be
   * called when the {@link TraceActivityLifecycleTracker#onActivityResumed(Activity)} is called.
   */
  @Test
   ...
   * If the given {@link TraceActivityLifecycleSink} is unregistered in the the
   * {@link TraceActivityLifecycleTracker} the
   * {@link TraceActivityLifecycleTracker#onActivityResumed(Activity)}
   * method of it should not be called when the
   ...
   * If the given {@link TraceActivityLifecycleSink} is not registered in the the
   * {@link TraceActivityLifecycleTracker} the
   * {@link TraceActivityLifecycleTracker#onActivityPaused(Activity)} method of it should not be
   * called when the {@link TraceActivityLifecycleTracker#onActivityPaused(Activity)} is called.
   */
  @Test
  public void onActivityPaused_ShouldBeNeverCalledIfNotRegistered() {
    ...
    verify(mockApplicationForegroundStateDataListener, never())
        .onActivityPaused(any(Activity.class));
  }

  /**
   * If the given {@link TraceActivityLifecycleSink} is registered in the the
   * {@link TraceActivityLifecycleTracker}
   * the {@link TraceActivityLifecycleTracker#onActivityPaused(Activity)} method of it should be
   * called when the {@link TraceActivityLifecycleTracker#onActivityPaused(Activity)} is called.
   */
  @Test
   ...
   * If the given {@link TraceActivityLifecycleSink} is unregistered in the the
   * {@link TraceActivityLifecycleTracker} the
   * {@link TraceActivityLifecycleTracker#onActivityPaused(Activity)}
   * method of it should not be called when the
   ...
   * If the given {@link TraceActivityLifecycleSink} is not registered in the the
   * {@link TraceActivityLifecycleTracker} the
   * {@link TraceActivityLifecycleTracker#onActivityStopped(Activity)} method of it should not be
   * called when the {@link TraceActivityLifecycleTracker#onActivityStopped(Activity)} is called.
   */
  @Test
  public void onActivityStopped_ShouldBeNeverCalledIfNotRegistered() {
    ...
    verify(mockApplicationForegroundStateDataListener, never())
        .onActivityStopped(any(Activity.class));
  }

  /**
   * If the given {@link TraceActivityLifecycleSink} is registered in the the
   * {@link TraceActivityLifecycleTracker}
   * the {@link TraceActivityLifecycleTracker#onActivityStopped(Activity)} method of it should be
   * called when the {@link TraceActivityLifecycleTracker#onActivityStopped(Activity)} is called.
   */
  @Test
   ...
   * If the given {@link TraceActivityLifecycleSink} is unregistered in the the
   * {@link TraceActivityLifecycleTracker} the
   * {@link TraceActivityLifecycleTracker#onActivityStopped(Activity)}
   * method of it should not be called when the
   ...
   * If the given {@link TraceActivityLifecycleSink} is not registered in the the
   * {@link TraceActivityLifecycleTracker} the
   * {@link TraceActivityLifecycleTracker#onActivityDestroyed(Activity)} method of it should not
   * be called when the {@link TraceActivityLifecycleTracker#onActivityDestroyed(Activity)} is
   * called.
   */
  @Test
  public void onActivityDestroyed_ShouldBeNeverCalledIfNotRegistered() {
    ...
    verify(mockApplicationForegroundStateDataListener, never())
        .onActivityDestroyed(any(Activity.class));
  }

  /**
   * If the given {@link TraceActivityLifecycleSink} is registered in the the
   * {@link TraceActivityLifecycleTracker}
   * the {@link TraceActivityLifecycleTracker#onActivityDestroyed(Activity)} method of it should
   * be called when the {@link TraceActivityLifecycleTracker#onActivityDestroyed(Activity)} is
   * called.
   */
  @Test
   ...
   * If the given {@link TraceActivityLifecycleSink} is unregistered in the the
   * {@link TraceActivityLifecycleTracker} the
   * {@link TraceActivityLifecycleTracker#onActivityDestroyed(Activity)}
   * method of it should not be called when the
   ...
   * If the given {@link TraceActivityLifecycleSink} is not registered in the the
   * {@link TraceActivityLifecycleTracker} the
   * {@link TraceActivityLifecycleTracker#onActivitySaveInstanceState(Activity, Bundle)} method
   * of it should not be called when the
   * {@link TraceActivityLifecycleTracker#onActivitySaveInstanceState(Activity, Bundle)} is called.
   */
  @Test
  public void onActivitySaveInstanceState_ShouldBeNeverCalledIfNotRegistered() {
    ...
    verify(mockApplicationForegroundStateDataListener, never())
        .onActivitySaveInstanceState(any(Activity.class),
            any(Bundle.class));
  }
   ...
   * If the given {@link TraceActivityLifecycleSink} is registered in the the
   * {@link TraceActivityLifecycleTracker}
   * the {@link TraceActivityLifecycleTracker#onActivitySaveInstanceState(Activity, Bundle)}
   * method of it should be called when the
   * {@link TraceActivityLifecycleTracker#onActivitySaveInstanceState(Activity, Bundle)} is called.
   */
  @Test
