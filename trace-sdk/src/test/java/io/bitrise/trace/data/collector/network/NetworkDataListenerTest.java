...
public class NetworkDataListenerTest {
    ...
    private final static String DUMMY_SPAN_ID = "0123456789ABCDEF";
    ...
    /**
     * When the {@link TraceManager} in the {@link NetworkDataListener} returns {@code null} for the parent Span ID,
     * method {@link NetworkDataListener#getRootSpanId()} should return an empty String.
     */
    @Test
    ...
    /**
     * When the {@link TraceManager} in the {@link NetworkDataListener} returns a non null value for the parent Span
     * ID, method {@link NetworkDataListener#getRootSpanId()} should return that ID.
     */
    @Test
