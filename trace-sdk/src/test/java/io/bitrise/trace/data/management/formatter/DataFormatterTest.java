...
public class DataFormatterTest {
    ...
    private final static String DUMMY_TRACE_ID = "ABCDEF";
    private final DataFormatter mockDataFormatter = mock(DataFormatter.class, Mockito.CALLS_REAL_METHODS);
    ...
    public void toFormattedDataArray_ListShouldContainTheSameSpans() {
        ...
        final FormattedData[] formattedDataArray = mockDataFormatter.toFormattedDataArray(spanList);
    ...
    public void toFormattedDataArray_ArrayShouldContainTheSameSpans() {
        ...
        final FormattedData[] formattedDataArray = mockDataFormatter.toFormattedDataArray(spans);
        for (int i = 0; i < formattedDataArray.length; i++) {
