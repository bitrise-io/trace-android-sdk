...
public class OkHttpDataListenerTest {
    ...
    /**
     * When there is no body for the given {@link Request}, method {@link OkHttpDataListener#getRequestSize(Request)}
     * should return the size of headers.
     */
    @Test
    ...
    /**
     * When there is body for the given {@link Request}, method {@link OkHttpDataListener#getRequestSize(Request)}
     * should return the size of headers and the body.
     *
    ...
    /**
     * When there is no body for the given {@link Response}, method {@link OkHttpDataListener#getResponseSize(Response)}
     * should return the size of headers.
     */
    @Test
    ...
    /**
     * When there is body for the given {@link Response}, method {@link OkHttpDataListener#getResponseSize(Response)}
     * should return the size of headers and the body.
     */
    @Test
    ...
    public void createNetworkData_ShouldCreateCorrectNetworkData() {
        final NetworkData actualValue = OkHttpDataListener.createNetworkData(DUMMY_REQUEST, DUMMY_RESPONSE,
        ...
        final NetworkData expectedValue =
                new NetworkData(DUMMY_SPAN_ID, DUMMY_ROOT_SPAN_ID).setMethod(DUMMY_REQUEST.method())
                                                                  .setRequestSize(OkHttpDataListener.getRequestSize(
                                                                          DUMMY_REQUEST))
                                                                  .setResponseSize(OkHttpDataListener.getResponseSize(
                                                                          DUMMY_RESPONSE))
                                                                  .setUrl(OkHttpDataListener.formatUrl(
                                                                          DUMMY_REQUEST.url()))
                                                                  .setStatusCode(DUMMY_RESPONSE.code())
                                                                  .setStart(DUMMY_START_TIME).setEnd(DUMMY_END_TIME);
