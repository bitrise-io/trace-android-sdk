...
public class TraceNetworkListenerTest {
    ...
    private static final Request DUMMY_REQUEST = new Request.Builder().url("https://bitrise.io").build();
    ...
    /**
     * Check that a call to {@link  TraceNetworkListener#getInstance()} should return the same instance.
     */
    @Test
    ...
    /**
     * By default no {@link OkHttpCallProcessor} should be registered in the {@link TraceNetworkListener}.
     */
    @Test
    public void registerOkHttpCallProcessor_ShouldNotBeRegistered() {
        traceNetworkListener.processOkHttpCall(DUMMY_REQUEST, DUMMY_RESPONSE, DUMMY_START_TIME, DUMMY_END_TIME);
     ...
     * {@link OkHttpCallProcessor#processOkHttpCall(Request, Response, long, long)} should be called when the
     * {@link TraceNetworkListener} receives a network call.
     */
    @Test
     ...
     * {@link OkHttpCallProcessor#processOkHttpCall(Request, Response, long, long)} should not be called when the
     * {@link TraceNetworkListener} receives a network call.
     */
    @Test
