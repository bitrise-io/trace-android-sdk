...
public class SpanAttributeAdapterTest {
    ...
    private final String jsonAttributeString = "{\"attribute_map\":{\"http.method\":{\"value\":{\"value_case\":1,\"value\":\"POST\"}}}}";
    private final String jsonAttributeInt = "{\"attribute_map\":{\"http.code\":{\"value\":{\"value_case\":2,\"value\":202}}}}";
    private final String jsonAttributeDouble = "{\"attribute_map\":{\"file.size\":{\"value\":{\"value_case\":4,\"value\":11.4}}}}";
    private final String jsonAttributeBoolean = "{\"attribute_map\":{\"success\":{\"value\":{\"value_case\":3,\"value\":false}}}}";
    private final String jsonAttributeUnknown = "{\"attribute_map\":{\"key\":{\"value\":{\"value_case\":9,\"value\":false}}}}";
    private final String jsonAttributeValueNotSet = "{\"attribute_map\":{\"success\":{\"value\":{\"value_case\":0}}}}";
    ...
    public void deserialize_booleanAttribute() {
        Span.Attributes attributes = NetworkClient.getGson()
                .fromJson(jsonAttributeBoolean, Span.Attributes.class);
    ...
    public void deserialize_valueNotSetAttribute() {
        Span.Attributes attributes = NetworkClient.getGson()
                .fromJson(jsonAttributeValueNotSet, Span.Attributes.class);
    ...
    public void deserialize_unknownType() {
        Span.Attributes attributes = NetworkClient.getGson()
                .fromJson(jsonAttributeUnknown, Span.Attributes.class);
        final Span.Attributes expectedAttributes = Span.Attributes.newBuilder().build();
        assertEquals(expectedAttributes, attributes);
    }
