...
public abstract class Scheduler {
     ...
     *
     * @param scheduledTime the exact time when the callback will be called. If the given time is already passed the
     *                      action will be triggered immediately.
     * @return the ID of if it is a Service, negative number if it is not a Service, or {@code null}if the action has
     * not been scheduled.
     */
    @Nullable
     ...
     *
     * @return the tag of if it is a Service, empty String if it is not a Service,  or {@code null} if the action has
     * not been scheduled.
     */
    @Nullable
