...
public final class LogMessageConstants {
  public static final String ACTIVITY_LIFECYCLE_COULD_NOT_BE_STARTED =
      "This means a TraceActivityLifecycleListener could not be created and Trace will not report"
          + " any activity information for this session.";
  public static final String ACTIVITY_LIFECYCLE_TRACKER_INITIALISED =
      "Activity lifecycle tracker initialised.";
  public static final String APPLICATION_SESSION_MANAGER_INITIALISED =
      "Application session initialised.";
  ...
  public static final String CONVERTER_FAILED_WITH_VALUE =
      "Converter failed to convert the following value: `%1$s`";
  public static final String COULD_NOT_REGISTER_FRAGMENT_LIFECYCLE_CALLBACK =
      "Trace may not report any information for this class.";
  public static final String COULD_NOT_DETERMINE_CDMA_OPERATOR_COUNTRY =
      "Could not determine CDMA operator country for this session, Trace may not report the "
          + "device country for this session.";
  public static final String COULD_NOT_DETERMINE_HEADER_SIZE =
      "Could not determine header size. Trace may report this network stat incorrectly.";
  ...
  public static final String DELETE_ALL_RESOURCE_ENTITIES =
      "All resource entities deleted from storage.";
  ...
  public static final String DELETE_RESOURCE_WITH_SESSION_ID =
      "Resource resources with session id '%1$s' from storage.";
  ...
  public static final String FAILED_TO_READ_APPLICATION_CPU_STATS =
      "Failed to read application CPU stats, Trace may not report any CPU stats for this session.";
  public static final String FAILED_TO_READ_CPU_STATS =
      "Failed to read CPU stats, result is out of bounds. This read will not be reported.";
  public static final String FAILED_TO_READ_SYSTEM_CPU_STATS =
      "Failed to read System CPU stats, Trace may not report any CPU stats for this session.";
  public static final String INITIALISING_SDK = "Initialising the Trace SDK";
  public static final String METRIC_HEADERS_MISSING =
      "Metric response headers missing, failed to complete header validation.";
  public static final String METRIC_HEADERS_MATCH = "Metric response headers match: %d sent";
  public static final String METRIC_HEADERS_INCORRECT =
      "Metric response headers do not match: %d sent and %d received.\nsent keys: %s\nreceived "
          + "keys: %s";
  ...
  public static final String SCHEDULER_SEND_CANCELLED =
      "Scheduler for sending data to Trace has been cancelled.";
  public static final String SCHEDULER_SEND_SCHEDULE_DELAYED =
      "Scheduler for sending data to Trace has been created with a delay of '%1$s'.";
  public static final String SET_URL_STREAM_HANDLER_FACTORY_FAILED =
      "setURLStreamHandlerFactory failed. This means the Trace SDK will not be able to capture "
          + "network metrics that use URLConnection. Please refer to the documentation for further"
          + " guidance.";
  ...
  public static final String TRACE_SDK_SUCCESSFULLY_INITIALISED =
      "Trace SDK is successfully initialised.";
