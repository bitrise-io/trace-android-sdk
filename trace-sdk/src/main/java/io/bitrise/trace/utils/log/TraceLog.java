...
public class TraceLog {
     ...
     * e.g. className - methodName() : exceptions localized message - an optional extra message we provide.
     *
     ...
     * e.g. className - methodName() : error's localized message - an optional extra message we provide.
     *
     ...
     */
    @Nonnull
    private static String getLocationInformationFromStackTraceElement(@NonNull StackTraceElement[] stackTraceElements) {

        // https://stackoverflow.com/a/4332163
        if (stackTraceElements.length >= 2) {

            // we're using the second element because we want the place just before the TraceLog was called.
