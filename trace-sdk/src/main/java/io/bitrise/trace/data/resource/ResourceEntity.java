...
/**
 * {@link androidx.room.Entity} for storing {@link io.opencensus.proto.resource.v1.Resource} labels in
 * {@link DataStorage}.
 */
@Entity
public class ResourceEntity {
    ...
    public boolean equals(@Nullable final Object o) {
        ...
        return resourceEntity.label.equals(label) && resourceEntity.id.equals(id) && resourceEntity.sessionId.equals(
                sessionId) && resourceEntity.value.equals(value);
    }
