...
/**
 * Data class for storing the required data for listening for Fragment lifecycle events. It should contain the
 * following data:
 * <ul>
 *      <li>lifecycle events that the given Fragment reached, to be able to identify the start and the end of it</li>
 *      <li>the name of the Fragment to be able to provide a human readable title for it on the frontend</li>
 *      <li>the Span ID of the parent (if there is one), to be able to create a hierarchy betweenthem</li>
...
public class FragmentData {
     ...
     * @param time          the time when the FragmentState was reached. See more info in the javadoc of
     *                      {@link #states}.
     */
