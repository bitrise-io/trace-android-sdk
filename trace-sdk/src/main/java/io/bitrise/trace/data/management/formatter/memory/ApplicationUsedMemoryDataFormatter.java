...
/**
 * {@link Formatter} implementation, to handle formatting for {@link DataSourceType#APP_USED_MEMORY}.
 */
public class ApplicationUsedMemoryDataFormatter extends MemoryDataFormatter {
    ...
    public FormattedData[] formatData(@NonNull final Data data) {
        ...
        return handleMemoryFormatting((Long) data.getContent(), MemoryType.APPLICATION);
    }
}
