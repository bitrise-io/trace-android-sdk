 ...
 * {@link ResourceEntity}s. Each entity will have it's own table in the database. Each member in the given entities
 * will be the columns in the tables.
 */
...
public abstract class TraceDatabase extends RoomDatabase {
    ...
    /**
     * Gets the {@link ResourceDao} to interact with {@link io.bitrise.trace.data.resource.ResourceEntity}s.
     *
