...
/**
 * Base abstract class for all {@link Formatter} implementations that work with
 * {@link ResourceEntity}s.
 */
public abstract class ResourceDataFormatter extends DataFormatter {
   ...
   * @return the Array of {@link FormattedData}.
   */
  @NonNull
  public static FormattedData[] formatResource(@NonNull final Data data,
                                               @NonNull final ResourceLabel resourceLabel) {
    ...
    final ResourceEntity resourceEntity =
        new ResourceEntity(resourceLabel.getName(), content.toString());
