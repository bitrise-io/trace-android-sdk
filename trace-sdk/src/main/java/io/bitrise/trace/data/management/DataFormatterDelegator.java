...
/**
 * Delegates the formatting of the different {@link Data} inputs to {@link Metric}s and {@link Trace}s to the proper
 * {@link Formatter} instances. This enables us, that a given {@link DataSource} is independent of the format of the
 * produced Data will be saved in.
 */
@Singleton
public class DataFormatterDelegator {
     ...
     */
    public synchronized static DataFormatterDelegator getInstance() {
    ...
    /**
     * Reads the {@link DataSourceType} of the Data and based on DataSourceType returns the proper {@link Formatter}.
     *
