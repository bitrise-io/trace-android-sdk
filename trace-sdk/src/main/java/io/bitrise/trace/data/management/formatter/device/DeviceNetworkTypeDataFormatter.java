...
/**
 * {@link Formatter} implementation, to handle formatting for {@link DataSourceType#NETWORK_TYPE}.
 */
public class DeviceNetworkTypeDataFormatter extends ResourceDataFormatter {

    @NonNull
    @Override
    public FormattedData[] formatData(@NonNull final Data data) {
        return new FormattedData[]{formatResource(data, ResourceLabel.DEVICE_NETWORK)};
    }
}
