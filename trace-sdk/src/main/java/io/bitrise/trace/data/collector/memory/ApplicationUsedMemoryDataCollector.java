...
/**
 * {@link DataCollector} type, that collects Total amount of used memory by the Application.
 * Memory management is a complex topic, to keep it simple, we calculate it as the Process Stats
 * do it. It is based on the PSS (Proportional Set Size). For more details see the linked pages.
 *
 * @see
