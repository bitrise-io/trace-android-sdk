...
/**
 * {@link Formatter} implementation, to handle formatting for {@link DataSourceType#SYSTEM_CPU_USAGE}.
 */
public class SystemCpuDataFormatter extends DataFormatter {
     ...
     */
    @NonNull
    public static Metric createSystemCpuMetric(@NonNull final CpuStat systemCpuStat, @NonNull final Timestamp timestamp) {
        ...
        final ArrayList<TimeSeries> systemTimeSeries = createSystemCpuTimeSeries(systemCpuStat, timestamp);
