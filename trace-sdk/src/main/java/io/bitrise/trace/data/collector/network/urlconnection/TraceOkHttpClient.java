...
public class TraceOkHttpClient {
  ...
  public static synchronized OkHttpClient getOkHttpClient(
    ...
    synchronized (lock) {
      ...
      String requestedOkHttpClientKey =
          generateOkHttpKey(proxy, connectionTimeout, followRedirects);
  ...
  @VisibleForTesting
  @NonNull
  static String generateOkHttpKey(@Nullable Proxy proxy, int connectionTimeout,
                                  boolean followRedirects) {
    if (proxy != null) {
