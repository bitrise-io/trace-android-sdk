...
/**
 * Formatter for networking related {@link DataListener} implementations, such as
 * {@link OkHttpDataListener}.
 */
public class NetworkDataFormatter extends DataFormatter {
  ...
  public static Span createNetworkSpan(@NonNull final NetworkData networkData,
    ...
    return Span.newBuilder()
               ...
               .setParentSpanId(
                   ByteString.copyFrom(networkData.getParentSpanId(), Charset.defaultCharset()))
  ...
  private static Span.Attributes createAttributes(@NonNull final NetworkData networkData) {
    return Span.Attributes.newBuilder()
                          ...
                          .putAttributeMap(
                              ...
                              createAttributeStringValue(
                                  Integer.toString(networkData.getStatusCode())))
                          .build();
  }
