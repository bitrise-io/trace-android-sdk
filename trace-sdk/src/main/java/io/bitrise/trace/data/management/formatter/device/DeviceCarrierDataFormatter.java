...
/**
 * {@link Formatter} implementation, to handle formatting for {@link DataSourceType#DEVICE_CARRIER}.
 */
public class DeviceCarrierDataFormatter extends ResourceDataFormatter {

    @NonNull
    @Override
    public FormattedData[] formatData(@NonNull final Data data) {
        return new FormattedData[]{formatResource(data, ResourceLabel.DEVICE_CARRIER)};
    }
}
