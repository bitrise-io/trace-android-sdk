...
/**
 * {@link DataListener} implementation for listening to the Application start times. Should be coupled with a
 * {@link ApplicationForegroundStateDataListener} and must run before it.
 */
public class ApplicationStartUpDataListener extends BaseDataListener implements TraceActivityLifecycleSink {

    /**
     * The {@link TraceActivityLifecycleTracker} to register for receiving the lifecycle event callbacks.
     */
    @NonNull
     ...
     * @param applicationForegroundStateDataListener the active {@link ApplicationForegroundStateDataListener} for
     *                                               getting the correct
     *                                               Application states.
     */
    public ApplicationStartUpDataListener(@NonNull final Context context,
                                          @NonNull final ApplicationForegroundStateDataListener applicationForegroundStateDataListener) {
    ...
    public void onActivityStarted(@NonNull final Activity activity) {
        ...
        isApplicationStart = applicationForegroundStateDataListener.hasApplicationJustComeFromBackground();
    ...
    /**
     * Creates an {@link ApplicationStartData} from the available information. The duration of the Application launch
     * should be the time elapsed between the creation and the resume of the first Activity.
     * <p>
     * The current {@link ApplicationStartType}s are determined in the following way:
     * <ul>
     *     <li>The Application should enter from the background</li>
     *     <li>{@link ApplicationStartType#COLD}, when the onCreate and onResume method was exactly once, because
