...
public class ActivityStateDataFormatter extends DataFormatter {
     ...
     * @return - the timestamp (in milliseconds) when the activity was started, or null if a start cannot
     * be found.
     */
    @Nullable
     ...
     * less accurate.
     * Note: We do not currently collect the PAUSED state in the collector.
     *
     * @param activityStates - the list of activity states.
     ...
     */
    @NonNull
    public static Span createActivityViewSpan(@NonNull final String name, final long start, final long end,
