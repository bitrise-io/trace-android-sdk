...
public class TraceHttpsURLConnection extends HttpsURLConnection {
    ...
    public String getCipherSuite() {
        return response.handshake() != null ?
                response.handshake().cipherSuite().toString() :
                null;
    }
    ...
    public Certificate[] getLocalCertificates() {
        return response.handshake() != null ?
                response.handshake().localCertificates().toArray(new Certificate[0]) :
                null;
    }
    ...
    public Certificate[] getServerCertificates() throws SSLPeerUnverifiedException {
        return response.handshake() != null ?
                response.handshake().peerCertificates().toArray(new Certificate[0]) :
                null;
    }
