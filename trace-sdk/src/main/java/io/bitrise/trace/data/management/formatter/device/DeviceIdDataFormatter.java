...
/**
 * {@link Formatter} implementation, to handle formatting for {@link DataSourceType#DEVICE_ID}.
 */
public class DeviceIdDataFormatter extends ResourceDataFormatter {

    @NonNull
    @Override
    public FormattedData[] formatData(@NonNull final Data data) {
        return new FormattedData[]{formatResource(data, ResourceLabel.DEVICE_ID)};
    }
}
