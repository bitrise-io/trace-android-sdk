...
/**
 * Data class for the required data that we want to extract from Activities. It should contain
 * the following data:
 * <ul>
 *     <li>lifecycle events that the given Activity reached, to be able to identify the start and
 *     the end of it</li>
 *     <li>the name of the Activity to be able to provide a human readable title for it on the
 *     frontend</li>
 *     <li>the Span ID of the Activity</li>
 * </ul>
 *
 * <p>Example format:
 * ActivityData{stateMap={CREATED=1191562272, STARTED=1191562450, STOPPED=1191563000}, name
 * ='MainActivity',
...
public class ActivityData {
  ...
  /**
   * A Map that stores the {@link ActivityState}s with the long value of current time on the
   * device, when the states have been reached. Use {@link TraceClock#getCurrentTimeMillis()} for
   ...
   * @param time          the time when the ActivityState was reached. See more info in the
   *                      javadoc of
   *                      {@link #stateMap}.
   */
