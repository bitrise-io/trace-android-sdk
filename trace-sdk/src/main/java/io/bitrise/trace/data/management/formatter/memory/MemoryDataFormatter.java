...
public abstract class MemoryDataFormatter extends DataFormatter {
   ...
   */
  private static TimeSeries createTimeSeries(final long memoryValue,
   ...
   */
  @NonNull
  public static Metric createMemoryMetric(final long memoryValue,
                                          final @NonNull MemoryType memoryType,
                                          @NonNull final Timestamp timestamp) {
  ...
  /**
   * Formats the common parts for {@link Metric}s, that got it's {@link Data} from a
   * {@link MemoryDataCollector}.
   *
