...
public class NetworkData {
  ...
  /**
   * Constructor for class. Requires an ID for the Span that will be created from it, and the
  ...
  public int hashCode() {
    return Objects
        .hash(start, end, url, statusCode, method, requestSize, responseSize, spanId, parentSpanId);
  }
}
