...
/**
 * Class used by the {@link TraceSdk} that is the single point for receiving network calls from
 * the application.
 */
@Singleton
public class TraceNetworkListener implements OkHttpCallProcessor {
  ...
  /**
   * A lock object for preventing concurrency issues for the {@link #traceNetworkListener}. E.g:
   * when {@link #reset()} and {@link #getInstance()} is called parallel.
   */
  @NonNull
   ...
   * @param okHttpCallProcessor the given OkHttpCallProcessor.
   */
  public void unregisterOkHttpCallProcessor(
      @NonNull final OkHttpCallProcessor okHttpCallProcessor) {
    synchronized (okHttpProcessorsLock) {
