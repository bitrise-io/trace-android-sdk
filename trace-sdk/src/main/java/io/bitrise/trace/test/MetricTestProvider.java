...
public class MetricTestProvider {
    ...
    /**
     * Gets a sample {@link Metric} for testing purposes, same as {@link #getSampleMetric()}, but with different
     * {@link TimeSeries}.
     *
     * @return the Metric.
     */
    ...
    /**
     * Creates an ApplicationUsedMemoryMetric that a {@link ApplicationUsedMemoryDataFormatter} would make.
     * @return a Metric representing an application memory used event.
     */
    @NonNull
    public static Metric getApplicationMemoryUsage() {
        return MemoryDataFormatter.createMemoryMetric(10L, MemoryDataFormatter.MemoryType.APPLICATION,
