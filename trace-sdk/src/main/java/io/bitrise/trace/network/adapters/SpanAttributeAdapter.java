 ...
 */
public class SpanAttributeAdapter implements JsonSerializer<Span.Attributes>, JsonDeserializer<Span.Attributes> {

    private final String PROPERTY_VALUE = "value";
    private final String PROPERTY_VALUE_CASE = "value_case";
    private final String PROPERTY_ATTRIBUTE_MAP = "attribute_map";

    @Override
    public Span.Attributes deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    ...
    @Override
    public JsonElement serialize(Span.Attributes src, Type typeOfSrc, JsonSerializationContext context) {
