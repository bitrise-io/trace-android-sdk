...
public class ChangeLogHelperTest extends TestParent {
  ...
  public void formatCommitToChangeLogEntry_ShouldHaveExpectedFormat() {
    final String actual =
        changeLogHelper.formatCommitToChangeLogEntry(dummyCommitMessage1).toString();
    final String expected =
        "* " + dummyCommitType1 + ": **" + dummyCommitTitle1 + ":** " + dummyCommitDetails1;
  ...
  public void getNewVersion_patchVersionIncrease() {
    final String actual =
        changeLogHelper.getNewVersion(dummyVersionName1, ChangeLogHelper.getPatchCommitTypes());
  ...
  public void getNewVersion_minorVersionIncrease() {
    final String actual =
        changeLogHelper.getNewVersion(dummyVersionName1, ChangeLogHelper.getMinorCommitTypes());
  ...
  public void getNewVersion_majorVersionIncrease() {
    final String actual =
        changeLogHelper.getNewVersion(dummyVersionName1, ChangeLogHelper.getMajorCommitTypes());
  ...
  public void getUpdatedChangeLogContent_MaintenanceRelease() {
    final List<String> actual =
        changeLogHelper.getUpdatedChangeLogContent(changeLogLines, dummyReleaseName,
    ...
    assertThat(actual.get(changeLogLines.size() - 2),
        is(UpdateChangeLogTask.maintenanceReleaseEntry));
  }
  ...
  @Test
  public void filterRelevantCommits_ShouldListOnlyRelevantCommits()
