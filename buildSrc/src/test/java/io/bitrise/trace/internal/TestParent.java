 ...
 * application (for example use "Finder" for macOS machines).
 *
 * @see
...
public abstract class TestParent {
  ...
  protected static final String dummyCommitMessage1 =
      String.format(dummyCommitTemplate, dummyCommitType1,
  ...
  protected static final String dummyCommitMessage2 =
      String.format(dummyCommitTemplate, dummyCommitType2,
  ...
  protected static final String dummyCommitDetails3 =
      "This was also needed. Modified previous file!";
  protected static final String dummyCommitFooter3 = "APM-34567";
  protected static final String dummyCommitMessage3 =
      String.format(dummyCommitTemplate, dummyCommitType3,
  ...
  protected static final String dummyCommitMessage5 =
      String.format(dummyCommitTemplate, dummyCommitType5,
  ...
  protected static final String dummyCommitMessage6 =
      String.format(dummyCommitTemplate, dummyCommitType6,
  ...
  protected static void initDummyRepo() throws GitAPIException, IOException {
    ...
    localDir.mkdirs();
    git = Git.cloneRepository().setURI(remoteRepo.getDirectory().getAbsolutePath())
   ...
   * @throws IOException if any I/O error occurs.
   */
  protected static boolean addDummyFile(final String moduleName, final String name)
      throws IOException {
   ...
   * @throws IOException if any I/O error occurs.
   */
  protected static void modifyDummyFile(final String moduleName, final String name)
      throws IOException {
  ...
  /**
   * Sets up a dummy repo in the {@link #tempFolder} with some commits and tags, for testing
   * purposes.
   *
   * @throws GitAPIException if any Git call fails.
   * @throws IOException     if any I/O error occurs.
  ...
  protected static void setupMockProjects() {
    when(mockRootProject.getAllprojects())
        .thenReturn(new HashSet<>(Collections.singletonList(mockProject1)));
    ...
    when(mockGradle.getIncludedBuilds())
        .thenReturn(new HashSet<>(Collections.singletonList(mockProject2)));
