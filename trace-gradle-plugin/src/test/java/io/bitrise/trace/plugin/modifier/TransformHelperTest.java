...
public class TransformHelperTest {
  ...
  private static final TransformHelper mockTransformHelper =
      new ApplicationTransformHelper(mock(Project.class), mock(BaseExtension.class),
          mock(Logger.class));
  ...
  /**
   * Copies from the resources a given File to the {@link #tempFolder}, under a new folder.
   ...
   * @throws IOException if any I/O occurs.
   */
  private File copyResourceToTempDir(@NonNull final String resourceName,
  ...
  public void makeFullyQualifiedName_nonEmptyValuesShouldReturnValid() {
    final String actualValue =
        TransformHelper.makeFullyQualifiedName(".ApplicationName", "com.example.package");
  ...
  public void addDirDependencyToClassPool_shouldContain() throws IOException {
    ...
    mockTransformHelper
        .addDirDependencyToClassPool(dummyClassPool, randomName, jarCopy.getParentFile());
