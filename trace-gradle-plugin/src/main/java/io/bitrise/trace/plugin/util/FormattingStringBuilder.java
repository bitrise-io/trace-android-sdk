...
public class FormattingStringBuilder {
  ...
  /**
   * Formats and appends the given String value to the builder. The formatting will make the text
   * lowercase, optionally capitalizes the first letter if it is not the first value in the builder.
   *
  ...
  /**
   * Formats the given String and appends to the builder. The formatting will capitalize only the
   * first letter, will not change other letters.
   *
   * @param value the String value.
   * @return this builder.
   */
