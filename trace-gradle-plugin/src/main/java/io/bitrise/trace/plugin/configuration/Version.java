...
public class Version implements Comparable<Version> {
    ...
    /**
     * Checks that this Version is supported or not. A version is considered to be supported, when it's major version
     * number is equal to the references major version number.
     *
    ...
    /**
     * A version number should be considered greater, if the major version number is higher. If they are equal, the
     * the minor version number is checked, if the minor version numbers are equal too, then the patch version is
     * checked. If the patch versions are equal too, then the two versions considered equal.
     *
