...
public class TaskUtils {
     ...
     */
    @NonNull
    public static ManifestProcessorTask getManifestProcessorTask(@NonNull final BaseVariantOutput output) {
     ...
     */
    @NonNull
    public static ProcessAndroidResources getResourceProcessorTask(@NonNull final BaseVariantOutput output) {
