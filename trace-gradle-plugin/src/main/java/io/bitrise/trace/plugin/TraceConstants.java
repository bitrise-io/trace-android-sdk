...
public final class TraceConstants {
     ...
     */
    public static final String BITRISE_ADDONS_CONFIGURATION_FILE = "bitrise-addons-configuration.json";
    ...
    /**
     * The smallest compatible version of the Android Gradle Plugin. Lower versions used in applications using the
     * SDK may have runtime or build errors, so they require different code.
     */
